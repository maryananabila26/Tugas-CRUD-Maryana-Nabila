  ...
  <body>
    <div>
        <div class="container2">
            <h4 class="judul">Tambah data Barang</h4>
            <div class="card">
                ...
                <div class="card-body">
                    <form  method="POST" action="{{url('barang')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                            <input type="text" class="form-control form-control-sm @error('txtkondisi') is-invalid @enderror" id="txtkondisi" name="txtkondisi" value="{{ old('txtkondisi') }}">
                            @error('txtkondisi')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                            <input type="number" class="form-control form-control-sm @error('txtberat') is-invalid @enderror" id="txtberat" name="txtberat" value="{{ old('txtberat') }}">
                            @error('txtberat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
